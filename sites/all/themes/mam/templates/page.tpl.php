...
<div id="page-wrapper"><div id="page">
  ...
  <div id="header" class="<?php print $secondary_menu ? 'with-secondary-menu': 'without-secondary-menu'; ?>"><div class="section clearfix container">
    ...
    <?php if ($main_menu): ?>
      <div id="main-menu" class="navigation">
        ...
        <a href="#close" id="close_btn" class="hide">x</a>
